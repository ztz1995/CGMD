...
if __name__ == '__main__':
    ...
    #
    parser = LmpParser()
    atom3d = parser.load_data_file(data_fp, "fg", map_dict={"Me":"c1", "c1":"c3"})
    parser.renew_coordinate_file(atom3d, trj_fp, 180000)
    # atom3d = parser.load_data_file("2blk_2.data", "fg", map_dict={"Me":"c1", "c1":"c3"})
    # print(atom3d)
    ...
    parser.create_data_file(atom3d, out_fp)
    # parser.create_data_file(atom3d, "fgh.2blk_2")